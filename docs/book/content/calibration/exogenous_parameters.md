...
| $\texttt{tax\_func\_type}$       | Functional form used for income tax functions                           | linear                                                |
...
| $\texttt{AIME\_bkt\_1}$          | First AIME bracket threshold                                            | 749.000                                               |
| $\texttt{AIME\_bkt\_2}$          | Second AIME bracket threshold                                           | 4517.000                                              |
| $\texttt{PIA\_rate\_bkt\_1}$     | First AIME bracket PIA rate                                             | 0.00E+00                                              |
| $\texttt{PIA\_rate\_bkt\_2}$     | Second AIME bracket PIA rate                                            | 0.00E+00                                              |
| $\texttt{PIA\_rate\_bkt\_3}$     | Third AIME bracket PIA rate                                             | 0.00E+00                                              |
| $\texttt{PIA\_maxpayment}$       | Maximum PIA payment                                                     | 0.00E+00                                              |
